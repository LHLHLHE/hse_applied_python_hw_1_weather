...
# Ниже представлены функции для синхронных и асинхронных запросов к API
...
# Но, так как в приложении streamlite нужна темпертарура для одного города, можно использовать синхронные запросы 
